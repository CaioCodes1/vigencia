package com.caiocodes.crbap.observability;

import com.caiocodes.crbap.shared.application.BusinessMetrics;
import com.caiocodes.crbap.shared.infrastructure.metrics.BusinessGauges;
...
class MetricsIT extends AbstractIamIntegrationTest {
    ...
    void deve_expor_as_metricas_de_negocio() throws Exception {
        ...
        assertThat(corpo)
                .contains("crbap_contracts_active")
                .contains("crbap_contracts_expiring_30d")
                .contains("crbap_billings_overdue_amount")
                .contains("crbap_outbox_pending");
        assertThat(valorDe(corpo, "crbap_contracts_active"))
                .as("um contrato ativo acabou de ser criado")
                .isEqualTo(1.0);
        assertThat(valorDe(corpo, "crbap_outbox_pending"))
    ...
    void deve_registrar_o_ultimo_sucesso_do_job() throws Exception {
        ...
        assertThat(raspar())
                .contains("crbap_scheduler_last_success_timestamp")
