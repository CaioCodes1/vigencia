package com.caiocodes.crbap.contract.web;

import com.caiocodes.crbap.contract.application.ActivateContractUseCase;
import com.caiocodes.crbap.contract.application.CancelContractUseCase;
import com.caiocodes.crbap.contract.application.ContractChain;
import com.caiocodes.crbap.contract.application.ContractCommands;
import com.caiocodes.crbap.contract.application.ContractDetail;
import com.caiocodes.crbap.contract.application.ContractSummary;
import com.caiocodes.crbap.contract.application.CreateContractUseCase;
import com.caiocodes.crbap.contract.application.ExpiringContracts;
import com.caiocodes.crbap.contract.application.GetContractUseCase;
import com.caiocodes.crbap.contract.application.RenewContractUseCase;
import com.caiocodes.crbap.contract.application.SuspendContractUseCase;
import com.caiocodes.crbap.contract.application.UpdateContractUseCase;
import com.caiocodes.crbap.contract.domain.ContractId;
import com.caiocodes.crbap.contract.domain.ContractStatus;
import com.caiocodes.crbap.contract.web.dto.ContractDtos.CreateContractRequest;
import com.caiocodes.crbap.contract.web.dto.ContractDtos.ReasonRequest;
import com.caiocodes.crbap.contract.web.dto.ContractDtos.RenewContractRequest;
import com.caiocodes.crbap.contract.web.dto.ContractDtos.UpdateContractRequest;
