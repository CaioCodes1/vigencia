package com.caiocodes.vigencia.contract.infrastructure.scheduler;

import com.caiocodes.vigencia.contract.application.AutoRenewContractsUseCase;
import com.caiocodes.vigencia.contract.application.ExpireContractsUseCase;
import com.caiocodes.vigencia.notification.application.ScanExpiringContractsUseCase;
...
public class ContractExpiryJob {
     ...
     */
    @Scheduled(cron = "${vigencia.jobs.expiry-cron:0 0 3 * * *}", zone = "America/Sao_Paulo")
