package com.caiocodes.vigencia.shared.infrastructure.messaging;
...
public class RabbitTopology {
    ...
    public static final String EXCHANGE = "vigencia.events";
    public static final String DLX = "vigencia.dlx";
    public static final String DLQ = "vigencia.dlq";
     ...
     * (fase 8) dispara com {@code rabbitmq_queue_messages{queue="vigencia.dlq"} > 0}.
     */
    @Bean
