 ...
 * a classe de {@code vigencia.security}: uma segunda classe de propriedades para
 * uma lista seria cerimônia. Ver {@link InternalNetworkAuthorizationManager}.
 */
@ConfigurationProperties(prefix = "vigencia.security")
public record JwtProperties(
    ...
    public JwtProperties {
        issuer = issuer == null ? "vigencia" : issuer;
        audience = audience == null ? "vigencia-api" : audience;
