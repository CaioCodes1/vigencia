package com.caiocodes.vigencia.iam.web.dto;

import com.caiocodes.vigencia.iam.application.AuthResult;
import com.caiocodes.vigencia.iam.application.UserProfile;
...
public final class AuthDtos {
    ...
    public record LoginRequest(
            @NotBlank @Email @Schema(example = "admin@vigencia.local") String email,
