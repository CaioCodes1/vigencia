...
import com.caiocodes.vigencia.iam.application.ChangePasswordUseCase;
import com.caiocodes.vigencia.iam.application.GetUserProfileUseCase;
import com.caiocodes.vigencia.iam.application.LoginCommand;
import com.caiocodes.vigencia.iam.application.LoginUseCase;
import com.caiocodes.vigencia.iam.application.LogoutCommand;
import com.caiocodes.vigencia.iam.application.LogoutUseCase;
import com.caiocodes.vigencia.iam.application.RefreshAccessTokenUseCase;
import com.caiocodes.vigencia.iam.application.RefreshCommand;
import com.caiocodes.vigencia.iam.infrastructure.security.AuthenticatedUser;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.AuthResponse;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.ChangePasswordRequest;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.LoginRequest;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.LogoutRequest;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.RefreshRequest;
import com.caiocodes.vigencia.iam.web.dto.AuthDtos.UserResponse;
